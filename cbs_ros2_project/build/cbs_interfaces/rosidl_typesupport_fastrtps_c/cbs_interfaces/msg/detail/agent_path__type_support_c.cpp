...
#include "cbs_interfaces/msg/detail/agent_path__rosidl_typesupport_fastrtps_c.h"
...
using _AgentPath__ros_msg_type = cbs_interfaces__msg__AgentPath;
...
static uint32_t _AgentPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cbs_interfaces__msg__AgentPath(
...
static size_t _AgentPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cbs_interfaces__msg__AgentPath(
