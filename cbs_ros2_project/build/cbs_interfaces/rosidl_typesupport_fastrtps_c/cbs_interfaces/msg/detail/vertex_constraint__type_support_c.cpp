...
#include "cbs_interfaces/msg/detail/vertex_constraint__rosidl_typesupport_fastrtps_c.h"
...
using _VertexConstraint__ros_msg_type = cbs_interfaces__msg__VertexConstraint;
...
static uint32_t _VertexConstraint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cbs_interfaces__msg__VertexConstraint(
...
static size_t _VertexConstraint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cbs_interfaces__msg__VertexConstraint(
