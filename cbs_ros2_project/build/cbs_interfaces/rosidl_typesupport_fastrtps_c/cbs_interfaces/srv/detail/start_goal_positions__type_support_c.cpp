...
#include "cbs_interfaces/srv/detail/start_goal_positions__rosidl_typesupport_fastrtps_c.h"
...
#include "cbs_interfaces/msg/detail/start_goal__functions.h"  // requests
...
using _StartGoalPositions_Request__ros_msg_type = cbs_interfaces__srv__StartGoalPositions_Request;
  ...
  // Field name: requests
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cbs_interfaces, msg, StartGoal
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: requests
  {
    ...
    if (ros_message->requests.data) {
      cbs_interfaces__msg__StartGoal__Sequence__fini(&ros_message->requests);
    }
...
size_t get_serialized_size_cbs_interfaces__srv__StartGoalPositions_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartGoalPositions_Request__ros_msg_type * ros_message = static_cast<const _StartGoalPositions_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name requests
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cbs_interfaces__msg__StartGoal(
...
static uint32_t _StartGoalPositions_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cbs_interfaces__srv__StartGoalPositions_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cbs_interfaces
size_t max_serialized_size_cbs_interfaces__srv__StartGoalPositions_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: requests
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_cbs_interfaces__msg__StartGoal(
...
static size_t _StartGoalPositions_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cbs_interfaces__srv__StartGoalPositions_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions_Request)() {
...
using _StartGoalPositions_Response__ros_msg_type = cbs_interfaces__srv__StartGoalPositions_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cbs_interfaces
size_t get_serialized_size_cbs_interfaces__srv__StartGoalPositions_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StartGoalPositions_Response__ros_msg_type * ros_message = static_cast<const _StartGoalPositions_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cbs_interfaces__srv__StartGoalPositions_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cbs_interfaces
size_t max_serialized_size_cbs_interfaces__srv__StartGoalPositions_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _StartGoalPositions_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cbs_interfaces__srv__StartGoalPositions_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions_Response)() {
...
// already included above
// #include "cbs_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cbs_interfaces/srv/start_goal_positions.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions)() {
