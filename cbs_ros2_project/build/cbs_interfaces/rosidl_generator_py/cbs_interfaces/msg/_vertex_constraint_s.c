...
bool cbs_interfaces__msg__vertex_constraint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cbs_interfaces.msg._vertex_constraint.VertexConstraint", full_classname_dest, 54) == 0);
  }
  cbs_interfaces__msg__VertexConstraint * ros_message = _ros_message;
  {  // cell_index
...
PyObject * cbs_interfaces__msg__vertex_constraint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cbs_interfaces.msg._vertex_constraint");
