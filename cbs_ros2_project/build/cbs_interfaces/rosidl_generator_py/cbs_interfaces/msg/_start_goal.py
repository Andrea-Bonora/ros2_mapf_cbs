...
class Metaclass_StartGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from cbs_interfaces.msg import Coordinates3D
...
class StartGoal(metaclass=Metaclass_StartGoal):
    ...
    _fields_and_field_types = {
        'start': 'cbs_interfaces/Coordinates3D',
        'goal': 'cbs_interfaces/Coordinates3D',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['cbs_interfaces', 'msg'], 'Coordinates3D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['cbs_interfaces', 'msg'], 'Coordinates3D'),  # noqa: E501
    )
