...
bool cbs_interfaces__msg__edge_constraint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cbs_interfaces.msg._edge_constraint.EdgeConstraint", full_classname_dest, 50) == 0);
  }
  cbs_interfaces__msg__EdgeConstraint * ros_message = _ros_message;
  {  // cell_from_index
...
PyObject * cbs_interfaces__msg__edge_constraint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cbs_interfaces.msg._edge_constraint");
