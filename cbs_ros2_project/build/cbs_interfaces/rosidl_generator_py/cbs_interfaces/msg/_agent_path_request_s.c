...
bool cbs_interfaces__msg__agent_path_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cbs_interfaces.msg._agent_path_request.AgentPathRequest", full_classname_dest, 55) == 0);
  }
  cbs_interfaces__msg__AgentPathRequest * ros_message = _ros_message;
  {  // name
...
PyObject * cbs_interfaces__msg__agent_path_request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cbs_interfaces.msg._agent_path_request");
