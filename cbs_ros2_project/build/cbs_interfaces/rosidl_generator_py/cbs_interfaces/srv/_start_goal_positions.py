...
class StartGoalPositions_Request(metaclass=Metaclass_StartGoalPositions_Request):
    ...
    _fields_and_field_types = {
        'requests': 'sequence<cbs_interfaces/StartGoal>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['cbs_interfaces', 'msg'], 'StartGoal')),  # noqa: E501
    )
...
class Metaclass_StartGoalPositions(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cbs_interfaces.srv.StartGoalPositions')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cbs_interfaces.srv import _start_goal_positions
...
class StartGoalPositions(metaclass=Metaclass_StartGoalPositions):
    from cbs_interfaces.srv._start_goal_positions import StartGoalPositions_Request as Request
    from cbs_interfaces.srv._start_goal_positions import StartGoalPositions_Response as Response
