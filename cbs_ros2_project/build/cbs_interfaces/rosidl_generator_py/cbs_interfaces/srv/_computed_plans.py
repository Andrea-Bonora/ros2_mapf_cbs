...
class Metaclass_ComputedPlans(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cbs_interfaces.srv.ComputedPlans')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cbs_interfaces.srv import _computed_plans
...
class ComputedPlans(metaclass=Metaclass_ComputedPlans):
    from cbs_interfaces.srv._computed_plans import ComputedPlans_Request as Request
    from cbs_interfaces.srv._computed_plans import ComputedPlans_Response as Response
