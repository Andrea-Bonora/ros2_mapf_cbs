...
static const _StartGoalPositions_Request_type_support_symbol_names_t _StartGoalPositions_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cbs_interfaces, srv, StartGoalPositions_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cbs_interfaces, srv, StartGoalPositions_Request)() {
  return &::cbs_interfaces::srv::rosidl_typesupport_c::StartGoalPositions_Request_message_type_support_handle;
}
...
static const _StartGoalPositions_Response_type_support_symbol_names_t _StartGoalPositions_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cbs_interfaces, srv, StartGoalPositions_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cbs_interfaces, srv, StartGoalPositions_Response)() {
  return &::cbs_interfaces::srv::rosidl_typesupport_c::StartGoalPositions_Response_message_type_support_handle;
}
...
static const _StartGoalPositions_type_support_symbol_names_t _StartGoalPositions_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, srv, StartGoalPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cbs_interfaces, srv, StartGoalPositions)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cbs_interfaces, srv, StartGoalPositions)() {
  return &::cbs_interfaces::srv::rosidl_typesupport_c::StartGoalPositions_service_type_support_handle;
}
