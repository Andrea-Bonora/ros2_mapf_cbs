...
static const _VertexConstraint_type_support_symbol_names_t _VertexConstraint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cbs_interfaces, msg, VertexConstraint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cbs_interfaces, msg, VertexConstraint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cbs_interfaces, msg, VertexConstraint)() {
  return &::cbs_interfaces::msg::rosidl_typesupport_c::VertexConstraint_message_type_support_handle;
}
