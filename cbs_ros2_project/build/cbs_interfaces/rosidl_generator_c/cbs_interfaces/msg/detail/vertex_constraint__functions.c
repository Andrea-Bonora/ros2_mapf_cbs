...
cbs_interfaces__msg__VertexConstraint__create()
{
  ...
  cbs_interfaces__msg__VertexConstraint * msg = (cbs_interfaces__msg__VertexConstraint *)allocator.allocate(sizeof(cbs_interfaces__msg__VertexConstraint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cbs_interfaces__msg__VertexConstraint));
  bool success = cbs_interfaces__msg__VertexConstraint__init(msg);
  if (!success) {
...
cbs_interfaces__msg__VertexConstraint__destroy(cbs_interfaces__msg__VertexConstraint * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    cbs_interfaces__msg__VertexConstraint__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
cbs_interfaces__msg__VertexConstraint__Sequence__init(cbs_interfaces__msg__VertexConstraint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cbs_interfaces__msg__VertexConstraint * data = NULL;

  if (size) {
    data = (cbs_interfaces__msg__VertexConstraint *)allocator.zero_allocate(size, sizeof(cbs_interfaces__msg__VertexConstraint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cbs_interfaces__msg__VertexConstraint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cbs_interfaces__msg__VertexConstraint__fini(&data[i - 1]);
      }
...
cbs_interfaces__msg__VertexConstraint__Sequence__fini(cbs_interfaces__msg__VertexConstraint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cbs_interfaces__msg__VertexConstraint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cbs_interfaces__msg__VertexConstraint__Sequence * array = (cbs_interfaces__msg__VertexConstraint__Sequence *)allocator.allocate(sizeof(cbs_interfaces__msg__VertexConstraint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cbs_interfaces__msg__VertexConstraint__Sequence__init(array, size);
  if (!success) {
...
cbs_interfaces__msg__VertexConstraint__Sequence__destroy(cbs_interfaces__msg__VertexConstraint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cbs_interfaces__msg__VertexConstraint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cbs_interfaces__msg__VertexConstraint__Sequence__are_equal(const cbs_interfaces__msg__VertexConstraint__Sequence * lhs, const cbs_interfaces__msg__VertexConstraint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cbs_interfaces__msg__VertexConstraint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cbs_interfaces__msg__VertexConstraint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cbs_interfaces__msg__VertexConstraint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cbs_interfaces__msg__VertexConstraint * data =
      (cbs_interfaces__msg__VertexConstraint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cbs_interfaces__msg__VertexConstraint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cbs_interfaces__msg__VertexConstraint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cbs_interfaces__msg__VertexConstraint__copy(
