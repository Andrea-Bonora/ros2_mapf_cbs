...
#ifndef CBS_INTERFACES__SRV__DETAIL__START_GOAL_POSE_STAMPED__FUNCTIONS_H_
#define CBS_INTERFACES__SRV__DETAIL__START_GOAL_POSE_STAMPED__FUNCTIONS_H_
 ...
 * calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Request__init().
...
/**
 * It calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Request__fini()
 ...
 * cbs_interfaces__srv__StartGoalPoseStamped_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cbs_interfaces
...
/**
 * It calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cbs_interfaces
...
/**
 * It allocates the memory for the array and calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cbs_interfaces
...
/**
 * It calls
 * cbs_interfaces__srv__StartGoalPoseStamped_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CBS_INTERFACES__SRV__DETAIL__START_GOAL_POSE_STAMPED__FUNCTIONS_H_
