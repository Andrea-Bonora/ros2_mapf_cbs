...
#include "cbs_interfaces/srv/detail/computed_plans__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cbs_interfaces::srv::ComputedPlans_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cbs_interfaces::srv::ComputedPlans_Request & ros_message)
{
  // Member: plans
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::srv::ComputedPlans_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cbs_interfaces::srv::ComputedPlans_Request *>(
    untyped_ros_message);
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, ComputedPlans_Request)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cbs_interfaces
cdr_serialize(
  const cbs_interfaces::srv::ComputedPlans_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cbs_interfaces::srv::ComputedPlans_Response & ros_message)
{
  // Member: collision_free_plans
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::srv::ComputedPlans_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cbs_interfaces::srv::ComputedPlans_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, ComputedPlans_Response)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans_Response__handle;
}
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, ComputedPlans)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_ComputedPlans__handle;
}
