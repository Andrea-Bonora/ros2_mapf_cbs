...
#include "cbs_interfaces/srv/detail/start_goal_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cbs_interfaces::msg::StartGoal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  cbs_interfaces::msg::StartGoal &);
...
cdr_serialize(
  const cbs_interfaces::srv::StartGoalPositions_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cbs_interfaces::srv::StartGoalPositions_Request & ros_message)
{
  // Member: requests
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: requests
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        cbs_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_StartGoal(
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::srv::StartGoalPositions_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cbs_interfaces::srv::StartGoalPositions_Request *>(
    untyped_ros_message);
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, StartGoalPositions_Request)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cbs_interfaces
cdr_serialize(
  const cbs_interfaces::srv::StartGoalPositions_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: plans
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cbs_interfaces::srv::StartGoalPositions_Response & ros_message)
{
  // Member: plans
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::srv::StartGoalPositions_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cbs_interfaces::srv::StartGoalPositions_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, StartGoalPositions_Response)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions_Response__handle;
}
...
{
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, srv, StartGoalPositions)() {
  return &cbs_interfaces::srv::typesupport_fastrtps_cpp::_StartGoalPositions__handle;
}
