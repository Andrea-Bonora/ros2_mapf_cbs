...
#include "cbs_interfaces/msg/detail/vertex_constraint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::msg::VertexConstraint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cbs_interfaces::msg::VertexConstraint *>(
    untyped_ros_message);
...
{
  return &cbs_interfaces::msg::typesupport_fastrtps_cpp::_VertexConstraint__handle;
}
