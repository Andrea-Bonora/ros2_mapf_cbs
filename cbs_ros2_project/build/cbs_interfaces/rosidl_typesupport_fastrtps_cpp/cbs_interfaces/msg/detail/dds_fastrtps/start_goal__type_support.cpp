...
#include "cbs_interfaces/msg/detail/start_goal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cbs_interfaces::msg::Coordinates3D &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  cbs_interfaces::msg::Coordinates3D &);
...
// functions for cbs_interfaces::msg::Coordinates3D already declared above
...
cdr_serialize(
  const cbs_interfaces::msg::StartGoal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cbs_interfaces::msg::StartGoal & ros_message)
{
  // Member: start
  ...
  size_t current_alignment)
{
  ...
  // Member: start
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        cbs_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Coordinates3D(
...
{
  auto typed_message =
    static_cast<const cbs_interfaces::msg::StartGoal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cbs_interfaces::msg::StartGoal *>(
    untyped_ros_message);
...
{
  return &cbs_interfaces::msg::typesupport_fastrtps_cpp::_StartGoal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, msg, StartGoal)() {
  return &cbs_interfaces::msg::typesupport_fastrtps_cpp::_StartGoal__handle;
}
