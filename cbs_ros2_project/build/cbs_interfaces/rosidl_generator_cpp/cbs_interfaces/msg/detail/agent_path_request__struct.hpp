...
#ifndef CBS_INTERFACES__MSG__DETAIL__AGENT_PATH_REQUEST__STRUCT_HPP_
#define CBS_INTERFACES__MSG__DETAIL__AGENT_PATH_REQUEST__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__cbs_interfaces__msg__AgentPathRequest __attribute__((deprecated))
#else
# define DEPRECATED__cbs_interfaces__msg__AgentPathRequest __declspec(deprecated)
#endif
...
struct AgentPathRequest_
{
  ...
  // pointer types
  using RawPtr =
    cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> *;
  using ConstRawPtr =
    const cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__cbs_interfaces__msg__AgentPathRequest
    std::shared_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__cbs_interfaces__msg__AgentPathRequest
    std::shared_ptr<cbs_interfaces::msg::AgentPathRequest_<ContainerAllocator> const>
...
using AgentPathRequest =
  cbs_interfaces::msg::AgentPathRequest_<std::allocator<void>>;
...
#endif  // CBS_INTERFACES__MSG__DETAIL__AGENT_PATH_REQUEST__STRUCT_HPP_
