...
{
  new (message_memory) cbs_interfaces::msg::EdgeConstraint(_init);
}

void EdgeConstraint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cbs_interfaces::msg::EdgeConstraint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EdgeConstraint_message_member_array[3] = {
  {
    ...
    offsetof(cbs_interfaces::msg::EdgeConstraint, cell_from_index),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::EdgeConstraint, cell_to_index),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::EdgeConstraint, time_step),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EdgeConstraint_message_members = {
  ...
  3,  // number of fields
  sizeof(cbs_interfaces::msg::EdgeConstraint),
...
{
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::EdgeConstraint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, msg, EdgeConstraint)() {
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::EdgeConstraint_message_type_support_handle;
}
