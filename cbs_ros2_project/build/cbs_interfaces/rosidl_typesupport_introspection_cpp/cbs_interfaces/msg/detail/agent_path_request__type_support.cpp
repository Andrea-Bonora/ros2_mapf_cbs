...
{
  new (message_memory) cbs_interfaces::msg::AgentPathRequest(_init);
}

void AgentPathRequest_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cbs_interfaces::msg::AgentPathRequest *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AgentPathRequest_message_member_array[5] = {
  {
    ...
    offsetof(cbs_interfaces::msg::AgentPathRequest, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::AgentPathRequest, start),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::AgentPathRequest, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::AgentPathRequest, vertex_constraints),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::AgentPathRequest, edge_constraints),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AgentPathRequest_message_members = {
  ...
  5,  // number of fields
  sizeof(cbs_interfaces::msg::AgentPathRequest),
...
{
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::AgentPathRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, msg, AgentPathRequest)() {
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::AgentPathRequest_message_type_support_handle;
}
