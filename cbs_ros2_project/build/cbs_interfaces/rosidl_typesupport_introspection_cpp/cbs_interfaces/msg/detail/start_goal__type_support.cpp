...
{
  new (message_memory) cbs_interfaces::msg::StartGoal(_init);
}

void StartGoal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cbs_interfaces::msg::StartGoal *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StartGoal_message_member_array[2] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<cbs_interfaces::msg::Coordinates3D>(),  // members of sub message
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::StartGoal, start),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::msg::StartGoal, goal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StartGoal_message_members = {
  ...
  2,  // number of fields
  sizeof(cbs_interfaces::msg::StartGoal),
...
{
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::StartGoal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, msg, StartGoal)() {
  return &::cbs_interfaces::msg::rosidl_typesupport_introspection_cpp::StartGoal_message_type_support_handle;
}
