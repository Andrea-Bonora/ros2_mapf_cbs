...
{
  new (message_memory) cbs_interfaces::srv::StartGoalPoseStamped_Request(_init);
}

void StartGoalPoseStamped_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cbs_interfaces::srv::StartGoalPoseStamped_Request *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<cbs_interfaces::msg::AgentPathRequest> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<cbs_interfaces::msg::AgentPathRequest> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<cbs_interfaces::msg::AgentPathRequest> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const cbs_interfaces::msg::AgentPathRequest *>(
    get_const_function__StartGoalPoseStamped_Request__requests(untyped_member, index));
  auto & value = *reinterpret_cast<cbs_interfaces::msg::AgentPathRequest *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<cbs_interfaces::msg::AgentPathRequest *>(
    get_function__StartGoalPoseStamped_Request__requests(untyped_member, index));
  const auto & value = *reinterpret_cast<const cbs_interfaces::msg::AgentPathRequest *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StartGoalPoseStamped_Request_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<cbs_interfaces::msg::AgentPathRequest>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::srv::StartGoalPoseStamped_Request, requests),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StartGoalPoseStamped_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(cbs_interfaces::srv::StartGoalPoseStamped_Request),
...
{
  return &::cbs_interfaces::srv::rosidl_typesupport_introspection_cpp::StartGoalPoseStamped_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, srv, StartGoalPoseStamped_Request)() {
  return &::cbs_interfaces::srv::rosidl_typesupport_introspection_cpp::StartGoalPoseStamped_Request_message_type_support_handle;
}
...
void StartGoalPoseStamped_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) cbs_interfaces::srv::StartGoalPoseStamped_Response(_init);
}

void StartGoalPoseStamped_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cbs_interfaces::srv::StartGoalPoseStamped_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StartGoalPoseStamped_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cbs_interfaces::srv::StartGoalPoseStamped_Response, plans),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StartGoalPoseStamped_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(cbs_interfaces::srv::StartGoalPoseStamped_Response),
...
{
  return &::cbs_interfaces::srv::rosidl_typesupport_introspection_cpp::StartGoalPoseStamped_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, srv, StartGoalPoseStamped_Response)() {
  return &::cbs_interfaces::srv::rosidl_typesupport_introspection_cpp::StartGoalPoseStamped_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers StartGoalPoseStamped_service_members = {
  ...
  // see get_service_type_support_handle<cbs_interfaces::srv::StartGoalPoseStamped>()
...
get_service_type_support_handle<cbs_interfaces::srv::StartGoalPoseStamped>()
{
  ...
  auto service_type_support =
    &::cbs_interfaces::srv::rosidl_typesupport_introspection_cpp::StartGoalPoseStamped_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, srv, StartGoalPoseStamped)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<cbs_interfaces::srv::StartGoalPoseStamped>();
}
