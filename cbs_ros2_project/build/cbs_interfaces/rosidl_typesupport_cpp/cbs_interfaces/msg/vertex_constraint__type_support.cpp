...
static const _VertexConstraint_type_support_symbol_names_t _VertexConstraint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, msg, VertexConstraint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, msg, VertexConstraint)),
  }
};
...
{
  return &::cbs_interfaces::msg::rosidl_typesupport_cpp::VertexConstraint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cbs_interfaces, msg, VertexConstraint)() {
  return get_message_type_support_handle<cbs_interfaces::msg::VertexConstraint>();
}
