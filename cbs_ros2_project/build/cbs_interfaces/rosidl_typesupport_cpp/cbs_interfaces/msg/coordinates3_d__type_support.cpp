...
static const _Coordinates3D_type_support_symbol_names_t _Coordinates3D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cbs_interfaces, msg, Coordinates3D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cbs_interfaces, msg, Coordinates3D)),
  }
};
...
{
  return &::cbs_interfaces::msg::rosidl_typesupport_cpp::Coordinates3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cbs_interfaces, msg, Coordinates3D)() {
  return get_message_type_support_handle<cbs_interfaces::msg::Coordinates3D>();
}
