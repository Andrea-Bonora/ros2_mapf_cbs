...
#ifndef CBS_NAV2_SMAC_PLANNER__SMOOTHER_HPP_
#define CBS_NAV2_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class cbs_nav2_smac_planner::PathSegment
...
/**
 * @struct cbs_nav2_smac_planner::BoundaryPoints
...
/**
 * @struct cbs_nav2_smac_planner::BoundaryExpansion
...
/**
 * @class cbs_nav2_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for cbs_nav2_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for cbs_nav2_smac_planner::Smoother
   */
  ~Smoother() {}
