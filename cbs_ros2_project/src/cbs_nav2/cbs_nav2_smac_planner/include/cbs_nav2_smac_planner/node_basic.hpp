...
#ifndef CBS_NAV2_SMAC_PLANNER__NODE_BASIC_HPP_
#define CBS_NAV2_SMAC_PLANNER__NODE_BASIC_HPP_
...
/**
 * @class cbs_nav2_smac_planner::NodeBasic
...
public:
  /**
   * @brief A constructor for cbs_nav2_smac_planner::NodeBasic
