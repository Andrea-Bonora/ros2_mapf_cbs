...
#ifndef CBS_NAV2_SMAC_PLANNER__NODE_LATTICE_HPP_
#define CBS_NAV2_SMAC_PLANNER__NODE_LATTICE_HPP_
...
#include "cbs_nav2_smac_planner/node_hybrid.hpp"
...
/**
 * @struct cbs_nav2_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for cbs_nav2_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class cbs_nav2_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for cbs_nav2_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const unsigned int index);

  /**
   * @brief A destructor for cbs_nav2_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    cbs_nav2_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
