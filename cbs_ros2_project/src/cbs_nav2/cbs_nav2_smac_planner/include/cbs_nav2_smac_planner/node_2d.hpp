...
#ifndef CBS_NAV2_SMAC_PLANNER__NODE_2D_HPP_
#define CBS_NAV2_SMAC_PLANNER__NODE_2D_HPP_
...
/**
 * @class cbs_nav2_smac_planner::Node2D
...
public:
  ...
  /**
   * @class cbs_nav2_smac_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for cbs_nav2_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const unsigned int index);

  /**
   * @brief A destructor for cbs_nav2_smac_planner::Node2D
   */
  ~Node2D();
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, cbs_nav2_smac_planner::Node2D * &)> & validity_checker,
