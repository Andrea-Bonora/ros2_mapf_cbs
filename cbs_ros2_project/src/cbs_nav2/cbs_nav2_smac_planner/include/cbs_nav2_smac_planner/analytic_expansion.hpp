...
#ifndef CBS_NAV2_SMAC_PLANNER__ANALYTIC_EXPANSION_HPP_
#define CBS_NAV2_SMAC_PLANNER__ANALYTIC_EXPANSION_HPP_
...
public:
  ...
  /**
   * @struct cbs_nav2_smac_planner::AnalyticExpansion::AnalyticExpansionNodes
