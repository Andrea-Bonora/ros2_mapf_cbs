...
#ifndef MY_NAV2_NAVFN_PLANNER__MY_NAVFN_PLANNER_HPP_
#define MY_NAV2_NAVFN_PLANNER__MY_NAVFN_PLANNER_HPP_
...
class MyNavfnPlanner : public my_nav2_core::MultiAgentGlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  std::unique_ptr<MyNavFn> planner_;
  ...
  // Logger
  rclcpp::Logger logger_{rclcpp::get_logger("MyNavfnPlanner")};
