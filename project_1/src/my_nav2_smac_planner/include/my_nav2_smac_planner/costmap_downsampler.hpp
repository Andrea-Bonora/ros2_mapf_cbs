...
#ifndef MY_NAV2_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
#define MY_NAV2_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
...
/**
 * @class my_nav2_smac_planner::CostmapDownsampler
