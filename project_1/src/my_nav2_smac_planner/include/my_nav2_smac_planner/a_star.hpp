...
#ifndef MY_NAV2_SMAC_PLANNER__A_STAR_HPP_
#define MY_NAV2_SMAC_PLANNER__A_STAR_HPP_
...
#include "my_nav2_smac_planner/thirdparty/robin_hood.h"
#include "my_nav2_smac_planner/analytic_expansion.hpp"
...
#include "my_nav2_smac_planner/node_basic.hpp"
...
/**
 * @class my_nav2_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct my_nav2_smac_planner::NodeComparator
  ...
  /**
   * @brief A constructor for my_nav2_smac_planner::PlannerServer
  ...
  /**
   * @brief A destructor for my_nav2_smac_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
