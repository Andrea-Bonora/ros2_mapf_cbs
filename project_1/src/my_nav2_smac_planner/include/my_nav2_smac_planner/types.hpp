...
#ifndef MY_NAV2_SMAC_PLANNER__TYPES_HPP_
#define MY_NAV2_SMAC_PLANNER__TYPES_HPP_
...
/**
 * @struct my_nav2_smac_planner::SearchInfo
...
/**
 * @struct my_nav2_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for my_nav2_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
...
/**
 * @struct my_nav2_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for my_nav2_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct my_nav2_smac_planner::LatticeMetadata
...
/**
 * @struct my_nav2_smac_planner::MotionPrimitive
