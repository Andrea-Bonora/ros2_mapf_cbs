...
#ifndef MY_NAV2_SMAC_PLANNER__ANALYTIC_EXPANSION_HPP_
#define MY_NAV2_SMAC_PLANNER__ANALYTIC_EXPANSION_HPP_
...
public:
  ...
  /**
   * @struct my_nav2_smac_planner::AnalyticExpansion::AnalyticExpansionNodes
