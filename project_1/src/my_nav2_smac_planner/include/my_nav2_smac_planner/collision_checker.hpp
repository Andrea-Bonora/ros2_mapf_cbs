...
#ifndef MY_NAV2_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define MY_NAV2_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace my_nav2_smac_planner
{

/**
 * @class my_nav2_smac_planner::GridCollisionChecker
...
public:
  /**
   * @brief A constructor for my_nav2_smac_planner::GridCollisionChecker
