...
#ifndef MY_NAV2_SMAC_PLANNER__NODE_HYBRID_HPP_
#define MY_NAV2_SMAC_PLANNER__NODE_HYBRID_HPP_
...
#include "my_nav2_smac_planner/costmap_downsampler.hpp"
...
/**
 * @struct my_nav2_smac_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for my_nav2_smac_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class my_nav2_smac_planner::NodeHybrid
...
public:
  ...
  /**
   * @class my_nav2_smac_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for my_nav2_smac_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for my_nav2_smac_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const unsigned int index);

  /**
   * @brief A destructor for my_nav2_smac_planner::NodeHybrid
   */
  ~NodeHybrid();
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, my_nav2_smac_planner::NodeHybrid * &)> & validity_checker,
