...
#ifndef MY_NAV2_SMAC_PLANNER__MY_SMAC_PLANNER_2D_HPP_
#define MY_NAV2_SMAC_PLANNER__MY_SMAC_PLANNER_2D_HPP_
...
#include "my_nav2_smac_planner/a_star.hpp"
#include "my_nav2_smac_planner/smoother.hpp"
...
class MySmacPlanner2D : public my_nav2_core::MultiAgentGlobalPlanner
{
public:
  /**
   * @brief constructor
...
protected:
  ...
  rclcpp::Logger _logger{rclcpp::get_logger("MySmacPlanner2D")};
