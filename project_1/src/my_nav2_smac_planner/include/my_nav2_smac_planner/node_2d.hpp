...
#ifndef MY_NAV2_SMAC_PLANNER__NODE_2D_HPP_
#define MY_NAV2_SMAC_PLANNER__NODE_2D_HPP_
...
/**
 * @class my_nav2_smac_planner::Node2D
...
public:
  ...
  /**
   * @class my_nav2_smac_planner::Node2D::Coordinates
  ...
  /**
   * @brief A constructor for my_nav2_smac_planner::Node2D
   * @param index The index of this node for self-reference
   */
  explicit Node2D(const unsigned int index);

  /**
   * @brief A destructor for my_nav2_smac_planner::Node2D
   */
  ~Node2D();
