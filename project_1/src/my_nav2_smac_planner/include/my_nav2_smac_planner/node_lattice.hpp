...
#ifndef MY_NAV2_SMAC_PLANNER__NODE_LATTICE_HPP_
#define MY_NAV2_SMAC_PLANNER__NODE_LATTICE_HPP_
...
#include "my_nav2_smac_planner/utils.hpp"
...
/**
 * @struct my_nav2_smac_planner::LatticeMotionTable
 * @brief A table of motion primitives and related functions
 */
struct LatticeMotionTable
{
  /**
   * @brief A constructor for my_nav2_smac_planner::LatticeMotionTable
   */
  LatticeMotionTable() {}
...
/**
 * @class my_nav2_smac_planner::NodeLattice
...
public:
  ...
  /**
   * @brief A constructor for my_nav2_smac_planner::NodeLattice
   * @param index The index of this node for self-reference
   */
  explicit NodeLattice(const unsigned int index);

  /**
   * @brief A destructor for my_nav2_smac_planner::NodeLattice
   */
  ~NodeLattice();
  ...
  void getNeighbors(
    ...
    my_nav2_smac_planner::NodeLattice * &)> & validity_checker,
    GridCollisionChecker * collision_checker,
    const bool & traverse_unknown,
