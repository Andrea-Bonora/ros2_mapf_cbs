...
#ifndef MY_NAV2_SMAC_PLANNER__SMOOTHER_HPP_
#define MY_NAV2_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @class my_nav2_smac_planner::PathSegment
...
/**
 * @struct my_nav2_smac_planner::BoundaryPoints
...
/**
 * @struct my_nav2_smac_planner::BoundaryExpansion
...
/**
 * @class my_nav2_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for my_nav2_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for my_nav2_smac_planner::Smoother
   */
  ~Smoother() {}
