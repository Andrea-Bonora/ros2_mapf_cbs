...
#include "Eigen/Core"
#include "my_nav2_smac_planner/smac_planner_lattice.hpp"
  ...
  std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  nav2_util::declare_parameter_if_not_declared(
    node, name + ".lattice_filepath", rclcpp::ParameterValue(
      ament_index_cpp::get_package_share_directory("my_nav2_smac_planner") +
...
PLUGINLIB_EXPORT_CLASS(my_nav2_smac_planner::SmacPlannerLattice, nav2_core::GlobalPlanner)
