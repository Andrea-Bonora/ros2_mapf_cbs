...
#ifndef MY_NAV2_PLANNER__MY_PLANNER_SERVER_HPP_
#define MY_NAV2_PLANNER__MY_PLANNER_SERVER_HPP_
 ...
 */
class MyPlannerServer : public nav2_util::LifecycleNode
{
public:
  /**
   * @brief A constructor for my_nav2_planner::MyPlannerServer
   * @param options Additional options to control creation of the node.
   */
  explicit MyPlannerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for my_nav2_planner::MyPlannerServer
   */
  ~MyPlannerServer();
...
protected:
  ...
  pluginlib::ClassLoader<my_nav2_core::MultiAgentGlobalPlanner> gp_loader_;
...
#endif  // MY_NAV2_PLANNER__MY_PLANNER_SERVER_HPP_
