...
{
  new (message_memory) my_intermediate_interfaces::msg::VertexConstraint(_init);
}

void VertexConstraint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_intermediate_interfaces::msg::VertexConstraint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember VertexConstraint_message_member_array[3] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_intermediate_interfaces::msg::VertexConstraint, time_step),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::VertexConstraint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_intermediate_interfaces, msg, VertexConstraint)() {
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::VertexConstraint_message_type_support_handle;
}
