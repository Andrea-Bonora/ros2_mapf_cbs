...
{
  new (message_memory) my_intermediate_interfaces::msg::Coordinates3D(_init);
}

void Coordinates3D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_intermediate_interfaces::msg::Coordinates3D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coordinates3D_message_member_array[3] = {
  {
    ...
    offsetof(my_intermediate_interfaces::msg::Coordinates3D, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_intermediate_interfaces::msg::Coordinates3D, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_intermediate_interfaces::msg::Coordinates3D, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coordinates3D_message_members = {
  ...
  3,  // number of fields
  sizeof(my_intermediate_interfaces::msg::Coordinates3D),
...
{
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::Coordinates3D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_intermediate_interfaces, msg, Coordinates3D)() {
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::Coordinates3D_message_type_support_handle;
}
