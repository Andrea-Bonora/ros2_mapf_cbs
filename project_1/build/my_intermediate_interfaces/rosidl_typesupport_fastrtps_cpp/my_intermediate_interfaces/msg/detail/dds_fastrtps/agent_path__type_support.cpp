...
#include "my_intermediate_interfaces/msg/detail/agent_path__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_intermediate_interfaces::msg::AgentPath & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_intermediate_interfaces::msg::AgentPath & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
...
{
  auto typed_message =
    static_cast<const my_intermediate_interfaces::msg::AgentPath *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_intermediate_interfaces::msg::AgentPath *>(
    untyped_ros_message);
...
{
  return &my_intermediate_interfaces::msg::typesupport_fastrtps_cpp::_AgentPath__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_intermediate_interfaces, msg, AgentPath)() {
  return &my_intermediate_interfaces::msg::typesupport_fastrtps_cpp::_AgentPath__handle;
}
