...
static const _ComputedPlans_Request_type_support_symbol_names_t _ComputedPlans_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_intermediate_interfaces, srv, ComputedPlans_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_intermediate_interfaces, srv, ComputedPlans_Request)() {
  return &::my_intermediate_interfaces::srv::rosidl_typesupport_c::ComputedPlans_Request_message_type_support_handle;
}
...
static const _ComputedPlans_Response_type_support_symbol_names_t _ComputedPlans_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_intermediate_interfaces, srv, ComputedPlans_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_intermediate_interfaces, srv, ComputedPlans_Response)() {
  return &::my_intermediate_interfaces::srv::rosidl_typesupport_c::ComputedPlans_Response_message_type_support_handle;
}
...
static const _ComputedPlans_type_support_symbol_names_t _ComputedPlans_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_intermediate_interfaces, srv, ComputedPlans)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_intermediate_interfaces, srv, ComputedPlans)() {
  return &::my_intermediate_interfaces::srv::rosidl_typesupport_c::ComputedPlans_service_type_support_handle;
}
