...
static const _AgentPathRequest_type_support_symbol_names_t _AgentPathRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, msg, AgentPathRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_intermediate_interfaces, msg, AgentPathRequest)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_intermediate_interfaces, msg, AgentPathRequest)() {
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_c::AgentPathRequest_message_type_support_handle;
}
