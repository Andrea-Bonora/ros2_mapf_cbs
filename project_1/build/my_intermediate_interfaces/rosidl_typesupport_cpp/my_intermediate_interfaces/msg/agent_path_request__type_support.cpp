...
static const _AgentPathRequest_type_support_symbol_names_t _AgentPathRequest_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_intermediate_interfaces, msg, AgentPathRequest)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_intermediate_interfaces, msg, AgentPathRequest)),
  }
};
...
{
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_cpp::AgentPathRequest_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_intermediate_interfaces, msg, AgentPathRequest)() {
  return get_message_type_support_handle<my_intermediate_interfaces::msg::AgentPathRequest>();
}
