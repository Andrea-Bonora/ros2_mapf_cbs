...
bool my_intermediate_interfaces__msg__agent_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_intermediate_interfaces.msg._agent_path.AgentPath", full_classname_dest, 52) == 0);
  }
  my_intermediate_interfaces__msg__AgentPath * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of AgentPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_intermediate_interfaces.msg._agent_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AgentPath");
