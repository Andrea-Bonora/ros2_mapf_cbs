...
bool my_intermediate_interfaces__msg__start_goal__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool my_intermediate_interfaces__srv__start_goal_positions__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // requests
    ...
    if (!my_intermediate_interfaces__msg__StartGoal__Sequence__init(&(ros_message->requests), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create my_intermediate_interfaces__msg__StartGoal__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    my_intermediate_interfaces__msg__StartGoal * dest = ros_message->requests.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!my_intermediate_interfaces__msg__start_goal__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * my_intermediate_interfaces__srv__start_goal_positions__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // requests
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = my_intermediate_interfaces__msg__start_goal__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
