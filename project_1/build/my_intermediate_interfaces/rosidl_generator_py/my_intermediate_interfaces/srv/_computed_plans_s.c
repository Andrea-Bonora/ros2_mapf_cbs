...
bool my_intermediate_interfaces__srv__computed_plans__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_intermediate_interfaces.srv._computed_plans.ComputedPlans_Request", full_classname_dest, 68) == 0);
  }
  my_intermediate_interfaces__srv__ComputedPlans_Request * ros_message = _ros_message;
  {  // plans
...
PyObject * my_intermediate_interfaces__srv__computed_plans__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_intermediate_interfaces.srv._computed_plans");
...
ROSIDL_GENERATOR_C_EXPORT
bool my_intermediate_interfaces__srv__computed_plans__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_intermediate_interfaces.srv._computed_plans.ComputedPlans_Response", full_classname_dest, 69) == 0);
  }
  my_intermediate_interfaces__srv__ComputedPlans_Response * ros_message = _ros_message;
