...
#include "my_intermediate_interfaces/srv/detail/computed_plans__rosidl_typesupport_fastrtps_c.h"
...
using _ComputedPlans_Request__ros_msg_type = my_intermediate_interfaces__srv__ComputedPlans_Request;
...
size_t get_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ComputedPlans_Request__ros_msg_type * ros_message = static_cast<const _ComputedPlans_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ComputedPlans_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_intermediate_interfaces
size_t max_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ComputedPlans_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans_Request)() {
...
using _ComputedPlans_Response__ros_msg_type = my_intermediate_interfaces__srv__ComputedPlans_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_intermediate_interfaces
size_t get_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ComputedPlans_Response__ros_msg_type * ros_message = static_cast<const _ComputedPlans_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_intermediate_interfaces
size_t max_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _ComputedPlans_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_intermediate_interfaces__srv__ComputedPlans_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans_Response)() {
...
// already included above
// #include "my_intermediate_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_intermediate_interfaces/srv/computed_plans.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, srv, ComputedPlans)() {
