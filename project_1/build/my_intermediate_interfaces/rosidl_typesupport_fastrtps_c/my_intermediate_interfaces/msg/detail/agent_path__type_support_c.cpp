...
#include "my_intermediate_interfaces/msg/detail/agent_path__rosidl_typesupport_fastrtps_c.h"
...
using _AgentPath__ros_msg_type = my_intermediate_interfaces__msg__AgentPath;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AgentPath__ros_msg_type * ros_message = static_cast<const _AgentPath__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AgentPath__ros_msg_type * ros_message = static_cast<_AgentPath__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _AgentPath__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_intermediate_interfaces__msg__AgentPath(
...
static size_t _AgentPath__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_intermediate_interfaces__msg__AgentPath(
...
static message_type_support_callbacks_t __callbacks_AgentPath = {
...
static rosidl_message_type_support_t _AgentPath__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AgentPath,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_intermediate_interfaces, msg, AgentPath)() {
  return &_AgentPath__type_support;
}
