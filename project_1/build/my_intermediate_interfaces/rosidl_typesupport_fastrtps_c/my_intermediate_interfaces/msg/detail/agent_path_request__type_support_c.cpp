...
#include "my_intermediate_interfaces/msg/detail/agent_path_request__rosidl_typesupport_fastrtps_c.h"
...
static uint32_t _AgentPathRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_intermediate_interfaces__msg__AgentPathRequest(
...
static size_t _AgentPathRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_intermediate_interfaces__msg__AgentPathRequest(
