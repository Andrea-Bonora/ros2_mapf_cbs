...
#include "my_intermediate_interfaces/msg/detail/start_goal__rosidl_typesupport_fastrtps_c.h"
...
#include "my_intermediate_interfaces/msg/detail/coordinates3_d__functions.h"  // goal, start
...
using _StartGoal__ros_msg_type = my_intermediate_interfaces__msg__StartGoal;
...
static uint32_t _StartGoal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_intermediate_interfaces__msg__StartGoal(
...
static size_t _StartGoal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_intermediate_interfaces__msg__StartGoal(
