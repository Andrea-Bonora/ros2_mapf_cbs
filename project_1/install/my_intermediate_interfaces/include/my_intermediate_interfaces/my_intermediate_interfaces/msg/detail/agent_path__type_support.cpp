...
{
  new (message_memory) my_intermediate_interfaces::msg::AgentPath(_init);
}

void AgentPath_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_intermediate_interfaces::msg::AgentPath *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AgentPath_message_member_array[2] = {
  {
    ...
    offsetof(my_intermediate_interfaces::msg::AgentPath, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_intermediate_interfaces::msg::AgentPath, path),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AgentPath_message_members = {
  ...
  2,  // number of fields
  sizeof(my_intermediate_interfaces::msg::AgentPath),
...
{
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::AgentPath_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_intermediate_interfaces, msg, AgentPath)() {
  return &::my_intermediate_interfaces::msg::rosidl_typesupport_introspection_cpp::AgentPath_message_type_support_handle;
}
