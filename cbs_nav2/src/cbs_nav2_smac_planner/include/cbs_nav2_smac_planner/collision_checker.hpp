...
#ifndef CBS_NAV2_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define CBS_NAV2_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace cbs_nav2_smac_planner
{

/**
 * @class cbs_nav2_smac_planner::GridCollisionChecker
...
public:
  /**
   * @brief A constructor for cbs_nav2_smac_planner::GridCollisionChecker
