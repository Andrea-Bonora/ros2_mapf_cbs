...
#ifndef CBS_NAV2_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
#define CBS_NAV2_SMAC_PLANNER__COSTMAP_DOWNSAMPLER_HPP_
...
/**
 * @class cbs_nav2_smac_planner::CostmapDownsampler
