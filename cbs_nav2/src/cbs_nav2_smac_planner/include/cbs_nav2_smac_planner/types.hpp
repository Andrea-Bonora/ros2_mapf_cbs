...
#ifndef CBS_NAV2_SMAC_PLANNER__TYPES_HPP_
#define CBS_NAV2_SMAC_PLANNER__TYPES_HPP_
...
/**
 * @struct cbs_nav2_smac_planner::SearchInfo
...
/**
 * @struct cbs_nav2_smac_planner::SmootherParams
 * @brief Parameters for the smoother
 */
struct SmootherParams
{
  /**
   * @brief A constructor for cbs_nav2_smac_planner::SmootherParams
   */
  SmootherParams()
  : holonomic_(false)
  {
...
/**
 * @struct cbs_nav2_smac_planner::MotionPose
 * @brief A struct for poses in motion primitives
 */
struct MotionPose
{
  /**
   * @brief A constructor for cbs_nav2_smac_planner::MotionPose
   */
  MotionPose() {}
...
/**
 * @struct cbs_nav2_smac_planner::LatticeMetadata
...
/**
 * @struct cbs_nav2_smac_planner::MotionPrimitive
