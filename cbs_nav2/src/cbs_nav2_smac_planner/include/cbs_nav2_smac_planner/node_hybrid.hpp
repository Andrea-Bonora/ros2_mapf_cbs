...
#ifndef CBS_NAV2_SMAC_PLANNER__NODE_HYBRID_HPP_
#define CBS_NAV2_SMAC_PLANNER__NODE_HYBRID_HPP_
...
#include "cbs_nav2_smac_planner/constants.hpp"
#include "cbs_nav2_smac_planner/types.hpp"
#include "cbs_nav2_smac_planner/collision_checker.hpp"
#include "cbs_nav2_smac_planner/costmap_downsampler.hpp"
...
/**
 * @struct cbs_nav2_smac_planner::HybridMotionTable
 * @brief A table of motion primitives and related functions
 */
struct HybridMotionTable
{
  /**
   * @brief A constructor for cbs_nav2_smac_planner::HybridMotionTable
   */
  HybridMotionTable() {}
...
/**
 * @class cbs_nav2_smac_planner::NodeHybrid
...
public:
  ...
  /**
   * @class cbs_nav2_smac_planner::NodeHybrid::Coordinates
   * @brief NodeHybrid implementation of coordinate structure
   */
  struct Coordinates
  {
    /**
     * @brief A constructor for cbs_nav2_smac_planner::NodeHybrid::Coordinates
     */
    Coordinates() {}
  ...
  /**
   * @brief A constructor for cbs_nav2_smac_planner::NodeHybrid
   * @param index The index of this node for self-reference
   */
  explicit NodeHybrid(const unsigned int index);

  /**
   * @brief A destructor for cbs_nav2_smac_planner::NodeHybrid
   */
  ~NodeHybrid();
   ...
   */
  void getNeighbors(
    std::function<bool(const unsigned int &, cbs_nav2_smac_planner::NodeHybrid * &)> & validity_checker,
