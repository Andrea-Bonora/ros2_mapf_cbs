...
#ifndef CBS_NAV2_PLANNER__CBS_PLANNER_SERVER_HPP_
#define CBS_NAV2_PLANNER__CBS_PLANNER_SERVER_HPP_
...
#include "cbs_nav2_core/multi_agent_global_planner.hpp"
#include "nav2_msgs/srv/is_path_valid.hpp"
#include "cbs_interfaces/action/compute_path_to_pose_cbs.hpp"

namespace cbs_nav2_planner
{
/**
 * @class cbs_nav2_planner::PlannerServer
 ...
 */
class CBSPlannerServer : public nav2_util::LifecycleNode
{
public:
  /**
   * @brief A constructor for cbs_nav2_planner::CBSPlannerServer
   * @param options Additional options to control creation of the node.
   */
  explicit CBSPlannerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for cbs_nav2_planner::CBSPlannerServer
   */
  ~CBSPlannerServer();

  using PlannerMap = std::unordered_map<std::string, cbs_nav2_core::MultiAgentGlobalPlanner::Ptr>;
...
protected:
  ...
  using ActionToPose = cbs_interfaces::action::ComputePathToPoseCBS;
  ...
  pluginlib::ClassLoader<cbs_nav2_core::MultiAgentGlobalPlanner> gp_loader_;
...
#endif  // CBS_NAV2_PLANNER__CBS_PLANNER_SERVER_HPP_
