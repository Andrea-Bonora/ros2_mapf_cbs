...
#include "my_robot_interfaces/srv/detail/set_led_status__rosidl_typesupport_fastrtps_c.h"
...
using _SetLedStatus_Request__ros_msg_type = my_robot_interfaces__srv__SetLedStatus_Request;
...
static uint32_t _SetLedStatus_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__SetLedStatus_Request(
...
static size_t _SetLedStatus_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__SetLedStatus_Request(
...
using _SetLedStatus_Response__ros_msg_type = my_robot_interfaces__srv__SetLedStatus_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__SetLedStatus_Response(
      untyped_ros_message, 0));
}
...
static size_t _SetLedStatus_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__SetLedStatus_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "my_robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_interfaces/srv/set_led_status.h"
