...
class Metaclass_SetLedStatus(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interfaces.srv.SetLedStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interfaces.srv import _set_led_status
...
class SetLedStatus(metaclass=Metaclass_SetLedStatus):
    from my_robot_interfaces.srv._set_led_status import SetLedStatus_Request as Request
    from my_robot_interfaces.srv._set_led_status import SetLedStatus_Response as Response
