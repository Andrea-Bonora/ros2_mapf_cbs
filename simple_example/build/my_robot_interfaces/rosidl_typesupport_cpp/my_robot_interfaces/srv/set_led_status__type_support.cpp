...
static const _SetLedStatus_Request_type_support_symbol_names_t _SetLedStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, SetLedStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, SetLedStatus_Request)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::SetLedStatus_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, SetLedStatus_Request)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::SetLedStatus_Request>();
}
...
static const _SetLedStatus_Response_type_support_symbol_names_t _SetLedStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, SetLedStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, SetLedStatus_Response)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::SetLedStatus_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, SetLedStatus_Response)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::SetLedStatus_Response>();
}
...
static const _SetLedStatus_type_support_symbol_names_t _SetLedStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, SetLedStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, SetLedStatus)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::SetLedStatus_service_type_support_handle;
}
