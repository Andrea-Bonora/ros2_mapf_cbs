...
class Conflict(object):
    ...
    def __str__(self):
        return '(' + str(self.type) + ", " + str(self.time_1) + ', ' + self.agent_1 + ', ' + str(self.location_1a) + ', ' + str(self.location_1b) + ', ' \
                + '(' + str(self.time_2) + ', ' + self.agent_2 + ', ' + str(self.location_2a) + ', ' + str(self.location_2b) + ', '